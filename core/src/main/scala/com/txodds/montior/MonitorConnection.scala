package com.txodds.monitor

import com.txodds.montior.JMXMonitoring
import org.slf4j.{ Logger, LoggerFactory }
import org.zeromq.ZMQ
/**
 * Created by kodjobaah on 13/06/2014.
 */
class MonitorConnection(context: ZMQ.Context, from: String, monitorName: String) extends Thread {
