 ...
 */
class ServerReaderMonitorConnection(context: ZMQ.Context, from: String, monitorName: String, readerOperations: ServerReaderOperations) extends Thread {

  val log: Logger = LoggerFactory.getLogger(classOf[ServerReaderMonitorConnection])
